...
run_lm_ind <- function(df, question) {
  ...
  # Print model summary
  cat("Model Summary with 95% Confidence Intervals:\n")
  print(results_table)
  cat("\n")
...
output_file_path <- file.path(
  output_path,
  "confidence_main_strict_idv_lm.txt"
)
...
for (question in questions) {
  ...
  cat("Strict dataset:\n")
  run_lm_ind(df_strict_main, question)
  cat("\n\n")
}
...
output_file_path <- file.path(
  output_path,
  "confidence_main_less_strict_idv_lm.txt"
)
...
for (question in questions) {
  ...
  run_lm_ind(df_less_strict_main, question)
  cat("\n\n")
}
...
output_file_path <- file.path(
  output_path,
  "confidence_main_super_strict_idv_lm.txt"
)
# Start redirecting output to the file
sink(output_file_path)
...
for (question in questions) {
  ...
  run_lm_ind(df_super_strict_main, question)
  cat("\n\n")
}
# Stop redirecting output
sink()
